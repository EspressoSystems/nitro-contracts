...
contract BridgeCreatorTest is Test {
  ...
  function assertEq(
    ...
    assertEq(
      address(a.sequencerInbox),
      address(b.sequencerInbox),
      'Invalid seqInbox'
    );
    assertEq(
  ...
  function test_updateTemplates() public {
    BridgeCreator.BridgeTemplates memory templs = BridgeCreator
      .BridgeTemplates({
