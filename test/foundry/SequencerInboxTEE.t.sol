...
contract SequencerInboxTest is Test {
    event TEEAttestationQuoteVerified(uint256 indexed sequenceNumber);
    ...
    function setUp() public {
        ...
        espressoTEEVerifier = new EspressoTEEVerifier(
            mrEnclave,
            mrSigner,
            //  Address of the V3Verifier contract on Sepolia
        ...
        seqInboxImpl = new SequencerInbox(
            maxDataSize, // Address of the Reader4844 contract on Sepolioa
            IReader4844(0xf6134C5849Fe8177163747288d41283B271B1624),
            false
        );
