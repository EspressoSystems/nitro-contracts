...
contract SequencerInboxTest is Test {
    ...
    uint256 awsNitroPrivateKey = 0x43179a4cba1a7fa58e6faad5cda5036169320c1a0c17b9f9488fb17acecaa23d;
    address nitroSignerAddr = address(0x5f0B0D79E7F051903b08E30a3d6eA50D80333932);
    uint256 public constant MAX_DATA_SIZE = 117964;

    TEEVerifierMock espressoTEEVerifier;
    ...
    function setUp() public {
        espressoTEEVerifier = new TEEVerifierMock();
        // Register both SGX and Nitro signers
        espressoTEEVerifier.addSigner(batchPosterAddress, IEspressoTEEVerifier.TeeType.SGX);
        espressoTEEVerifier.addSigner(nitroSignerAddr, IEspressoTEEVerifier.TeeType.NITRO);
        ...
        seqInboxImpl = new SequencerInbox(maxDataSize, IReader4844(reader4844), false, false);
