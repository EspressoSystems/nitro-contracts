...
contract SequencerInboxBlobsTEE is Test {
  ...
  function setUp() public {
    ...
    string
      memory attestationPath = '/test/foundry/configs/nitro-attestation.bin';
    string memory attestationFile = string.concat(
      vm.projectRoot(),
      attestationPath
    );
  ...
  function testAddSequencerL2BatchFromBlobs() public {
    ...
    dataHashes[
      0
    ] = hex'014e8e17947683a76729b8efd62f59785227e0011c4ace32d7887589acd46ee7';
