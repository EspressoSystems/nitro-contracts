...
contract SequencerInboxTest is Test {
  ...
  function deployRollup(
    ...
    seqInbox.initialize(bridge, maxTimeVariation, bufferConfig, address(espressoTEEVerifier));
  ...
  function deployFeeTokenBasedRollup() internal returns (SequencerInbox, ERC20Bridge) {
    ...
    seqInbox.initialize(bridge, maxTimeVariation, bufferConfigDefault, address(espressoTEEVerifier));
  ...
  function testInitialize(
    ...
    seqInboxProxy.initialize(IBridge(_bridge), maxTimeVariation, bufferConfig, address(espressoTEEVerifier));
